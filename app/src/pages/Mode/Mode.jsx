  ...
  return (
    <div className="bg-[url(/src/assets/Home-Background.jpg)] h-[100vh] bg-cover">
      <botton className="inline-flex absolute left-[32px] top-[32px]">
        <a href="/" className="p-1 rounded border-2 text-black bg-amber-500 hover:text-white hover:bg-blue-600 hover:border-blue-600">
      ...
      <div className="flex text-center justify-center font-game ">
        <div className="text-[100px]">
          ...
          <div className="text-[42px] p-[50px] mt-27 text-green-200 text-stroke-black">
            <h1
            >Choose
            </h1>
            <p>mode</p>
          ...
          <div className="mt-8 flex flex-col ">
            <div className="text-[20px] w-[360px] h-[68px] bg-amber-400 p-4 px-10 mx-18 border-3 flex items-center justify-center"
            >Heart mode <Heart fill="red" size={30} className="ml-8"/>
            </div>
            <botton className="mt-12 text-[20px] w-[360px] h-[68px] bg-amber-400 p-4 px-8 mx-18 border-3 flex items-center justify-center"
