...
import SkullC1 from "../../assets/SkullC1.gif"
...
function WordIndex() {
  ...
  return (
    <div className="bg-[url(/src/backgrounds/bg-map.jpg)] h-[896px] bg-cover p-4 flex flex-col justify-between">
      ...
      <div>
        <div className="text-[30px] flex justify-center mt-4 text-[#C5E369] text-outline-2 ">Flashcard</div>
      ...
      <div className='flex justify-between'>
        <div className="h-[56px] w-[56px] border-[2px] bg-[#E29F51] rounded-full grid place-items-center">
          ...
          <CircleHelp className="h-[56px] w-[56px] fill-[#E29F51] stroke-[1px]" onClick={handleHelp}  />
          {help && (
            <div className="fixed inset-0 bg-black/50 z-10" onClick={handleHelp}></div>     
          )}
          {help && (
              <div className='fixed inset-0 flex justify-center items-center z-10' onClick={handleHelp}>
                <div className='h-[80vh] w-[90vw] border-2 bg-[#f7eab2] flex flex-col justify-between items-center py-4'>
                  <div className='flex'>
                  <div className='text-center text-[12px]  w-[40vw]'><img src={SkullA1} alt="SkullA1" />Level : A1</div>
                  <div className='text-center text-[12px]  w-[40vw]'><img src={SkullA2} alt="SkullA1" />Level : A2</div>
                  </div>
                  <div className='flex'>
                  <div className='text-center text-[12px]  w-[40vw]'><img src={SkullB1} alt="SkullA1" />Level : B1</div>
                  <div className='text-center text-[12px]  w-[40vw]'><img src={SkullB2} alt="SkullA1" />Level : B2</div>
                  </div>
                  <div className='flex'>
                  <div className='text-center text-[12px]  w-[40vw]'><img src={SkullC1} alt="SkullA1" />Level : C1</div>
                  </div>
