...
export default function Game() {
  ...
  return (
    ...
    <div className="gif_box pt-100 flex justify-center">
        <img className=" w-[197px] h-[246px] " src="Idle.gif" alt="Human"></img>
    ...
    <div class="Choice_Box" className='w-full inline-flex gap-5 justify-center pt-5  '>
    <button type="button"  className='w-[160px] h-[65px] bg-[#E29F51] text-center border-2 text-2xl '>กล้วย</button>
    <button  className='w-[160px] h-[65px] bg-[#E29F51] text-center border-2 text-2xl '>ส้ม</button>
    </div>
    </div>
    </div>
